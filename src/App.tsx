  ...
  <div className ="background" style ={{backgroundColor: randomColor , transition}}>
    <div id="quote-box">
      <div className="quote-content" style = {{color: randomColor , transition}}>
        ...
        <h2 id ="text"><FaQuoteLeft size ="25" style = {{ marginRight: "5px"}} />
                                      {quote.quote}
      ...
      <div className = "buttons">
        <a 
        href={"https://nottwitter.com/intent/tweet?text=quotegoeshere"}
        id="tweet-quote"
        style = {{
        ...
        style ={{backgroundColor: randomColor, transition}}>Change Quote</button>
      </div>
    </div>
  </div>
    )
